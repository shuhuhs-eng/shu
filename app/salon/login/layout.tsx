// app/(auth)/layout.tsx と完全に同一の見た目を、役割別ログイン入口にも適用する
// （(auth)ルートグループの外にあるため、layoutは自動適用されない）。
export default function SalonLoginLayout({ children }: { children: React.ReactNode }) {
  return (
